 ...
 * information which is the property of Sagemcom Broadband. The program
 * may be used and/or copied only with the written permission of
 * Sagemcom Broadband. or in accordance with the terms and conditions
 ...
 */
x_export void s_list_free(struct s_list *list);
 ...
 * @return if succeed 0 is returned else other value (see errno)
 */
x_export void s_list_free_full(struct s_list *list, s_destroy_cbk func);
 ...
 */
x_export struct s_list *s_list_append(struct s_list *list, void *data);
 ...
 */
x_export struct s_list *s_list_prepend(struct s_list *list, void *data);
 ...
 */
x_export struct s_list *s_list_insert(struct s_list *list, void *data,
  uint32_t position);
 ...
 * pointer.
 */
x_export struct s_list *s_list_insert_before(struct s_list *list,
 ...
 * @return the (possibly changed) start of the list
 */
x_export struct s_list *s_list_remove(struct s_list *list, void *data);
 ...
 */
x_export struct s_list *s_list_remove_link(struct s_list *list,
  struct s_list *llist);
 ...
 * @return the (possibly changed) start of the list
 */
x_export struct s_list *s_list_delete_link(struct s_list *list,
  struct s_list *link);
 ...
 * @return the (possibly changed) start of the list
 */
x_export struct s_list *s_list_remove_all(struct s_list *list, void *data);
 ...
 */
x_export uint32_t s_list_length(struct s_list *list);
 ...
 */
x_export struct s_list *s_list_copy(struct s_list *list);
 ...
 * @return the start of the new list that holds the same data as list
*/
x_export struct s_list *s_list_deep_copy(struct s_list *list,
 ...
 */
x_export struct s_list *s_list_concat(struct s_list *list1,
  struct s_list *list2);
 ...
 */
x_export void s_list_foreach(struct s_list *list, s_foreach_cbk func,
  void *user_data);
 ...
 */
x_export struct s_list *s_list_first(struct s_list *list);
 ...
 */
x_export struct s_list *s_list_last(struct s_list *list);
 ...
 */
x_export struct s_list *s_list_nth(struct s_list *list, uint32_t nth);
 ...
 */
x_export struct s_list *s_list_find(struct s_list *list, void *data);
